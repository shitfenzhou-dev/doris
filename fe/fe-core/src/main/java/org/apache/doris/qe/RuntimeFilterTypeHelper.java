...
public class RuntimeFilterTypeHelper {
    ...
    private static class InnerConverter extends AbstractFlagConverter {
        InnerConverter() {
            super(SessionVariable.RUNTIME_FILTER_TYPE, ALLOWED_MASK, varValueSet);
        }

        @Override
        protected long postProcess(long resultCode) throws DdlException {
            int count = 0;
    ...
    public static String decode(Long varValue) throws DdlException {
        return CONVERTER.decode(varValue);
    }
